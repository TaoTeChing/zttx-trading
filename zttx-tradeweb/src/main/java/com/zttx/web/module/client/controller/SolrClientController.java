...
/**
 * <p>File：ManagerSolrController.java </p>
 * <p>Title: 管理solr服务的控制器 </p>
 * <p>Description: ManagerSolrController </p>
...
public class SolrClientController extends GenericController {
    @Autowired
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/solr/buildSolr")
    public JsonMessage buildSolr(HttpServletRequest request, ClientParameter param) throws BusinessException {
        JsonMessage json = new JsonMessage(CommonConst.FAIL);
        Map<String, String> map = ParameterUtils.getMapFromParameter(param);
        String core = MapUtils.getString(map, "coreName");
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/solr/rebuildSolr")
    public JsonMessage rebuildSolr(HttpServletRequest request, ClientParameter param) throws BusinessException {
        cleanSolr(request, param);
        return buildSolr(request, param);
    }
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/solr/cleanSolr")
    public JsonMessage cleanSolr(HttpServletRequest request, ClientParameter param) throws BusinessException {
        JsonMessage json = new JsonMessage(CommonConst.FAIL);
        Map<String, String> map = ParameterUtils.getMapFromParameter(param);
        String coreName = MapUtils.getString(map, "coreName");
        if (SolrjHandler.delDocByQuery("*:*", coreName)) {
