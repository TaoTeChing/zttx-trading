...
<head>
    ...
    <style>
        ...
        .m-cates .list-filter .drop{position: absolute;top: 39px;left: -76px;width: 1158px;line-height: 30px;padding: 11px 15px;border: 1px solid #e5e5e5;background-color: #fff;display: none;}
        ...
        .m-selbrand{width:1186px;height:146px;margin-top:15px;border:2px solid #e5e5e5;font-family: "Microsoft yahei";}
        .m-selbrand .i1,
        .m-selbrand .i2,
        .m-selbrand .i3,
        .m-selbrand .i4,
        ...
        .m-selbrand .i1{width: 200px;margin-right: 0;text-align: center;}
        .m-selbrand .i2{width: 270px;}
        .m-selbrand .i3{width: 255px;margin-top:30px;padding-left: 30px;}
        .m-selbrand .i4{margin-top:30px;margin-right: 0;}
        .m-selbrand .i5{margin-right: 0;margin-left: 40px;}
        .m-selbrand .item-logo{margin-top: 25px;}
        .m-selbrand .item-logo .js-img-center{display: inline-block;*display: inline;*zoom: 1;width:80px;height:40px;}
        .m-selbrand .item-logo .js-img-center img{max-width:80px;max-height:40px;_width:80px;_height:40px;}
        .m-selbrand .item-name{margin: 10px 0;}
        .m-selbrand .item-follow{display: inline-block;*display: inline;*zoom: 1;padding:0 10px;;border: 1px solid #e5e5e5;border-radius: 3px;cursor: pointer;}
        .m-selbrand h3{margin-bottom:5px;font-size: 14px;}
        .m-selbrand .item-address{margin-bottom:10px;color:#666;}
        .m-selbrand .item-com{line-height: 24px;}
        .m-selbrand .item-com span{color: #666;}
        .m-selbrand .item-com em{color: #e00;}
        .m-selbrand .item-btns{margin-top:30px;}
        .m-selbrand .item-btns a{display: block;width:98px;padding: 5px 0;background-color:#f80;text-align: center;color:#fff;-webkit-transition: 0.3s;-moz-transition: 0.3s;-o-transition: 0.3s;transition: 0.3s;}
        .m-selbrand .item-btns a:hover{background-color: #f60;}
        .m-selbrand .item-btns .btn1{margin-bottom:20px;background-color:#e00;}
        .m-selbrand .item-btns .btn1:hover{background-color:#c00;}
        .m-selbrand .item-more{color:#1d7ad9;}
    </style>
</head>
<body>
<div class="container">
    ...
    <div class="main ts-container">
        <%-- 选中品牌之后有m-selbrand --%>
        <div class="m-selbrand">
            <div class="clearfix">
                <div class="i1">
                    <div class="item-logo">
                        <a href="#" class="js-img-center"><img src="" alt="" width="80" height="40"/></a>
                    </div>
                    <div class="item-name"><a href="">艾谛菲</a></div>
                    <div class="item-follow">关注</div>
                </div>
                <div class="i2">
                    <img src="" alt="" width="270" height="146"/>
                </div>
                <div class="i3">
        ...
        <div class="m-cates">
            ...
            <div class="m-mod clearfix" style="border-bottom: 0;">
        ...
        <div class="m-filter clearfix">
            <ul class="inline-float fl">
                ...
                <li class="m-f-1"><a href="javascript:;" title="人气从高到低">人气</a></li>
                <li class="m-f-1"><a href="javascript:;" title="销量从高到低">销量</a></li>
                <li class="m-f-1"><a href="javascript:;" title="时间从近到远">时间</a></li>
        ...
        <div class="m-recom clearfix">
            <div class="fl">
                ...
                <label><input type="checkbox"/><span>支持拿样</span><i class="icon-nayang"></i></label>
                <label><input type="checkbox"/><span>我的授权商品</span><i class="icon-shouxin"></i></label>
                <label><input type="checkbox"/><span>我的授信商品</span><i class="icon-yuding"></i></label>
            </div>
            <div class="fr">
        ...
        <div class="m-list">
            <ul class="inline-float">
                <li>
                    <div class="pic">
                        <a href="" class="js-img-center"><img src="" alt="" width="220" height="220"/></a>
                    </div>
                    <div class="operate">
                    ...
                    <div class="detail">
                        ...
                        <div class="address clearfix">
                            <a class="fl" href="#" title="舟山XX店">舟山XX店</a>
                            <a class="fr" href="javascript:;" title="浙江">浙江</a>
                        </div>
                        <div class="clearfix">
