        ...
        <div class="log-coll fl">
            ...
            <form class="ui-form" action="${ctx}/tradeMeeting/activity/signup">
                ...
                <div class="ui-form-item clearfix">
                    ...
                    <input type="submit" class="btn1" value="提交" name="businessCategory"/>
                </div>
            </form>
        </div>
...
<script>
    $(function(){
        $('.ui-form').find(".btn1").click(function () {
            ...
            if (Parameter.realName.length > 1 && Parameter.realName.length < 5 && Parameter.mobile.length == 11 && Parameter.businessCategory.length < 33) {
                $.post("${ctx}/tradeMeeting/activity/signup", Parameter, function (data) {
                    if (data.code == 126000) {
