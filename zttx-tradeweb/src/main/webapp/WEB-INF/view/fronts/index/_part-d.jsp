...
<c:set var="result" value="${fns:searchBrandesResult('100000000',notIn)}"/>
<div class="hall clearfix">
	<div class="fl hall-m">
		<div class="tit clearfix">
			<h4 class="fl"><a href="${ctx}/man?st=b">男装品牌馆</a></h4>
			<a href="${ctx}/man?st=b" class="more_1 fr"></a>
		</div>
		<div class="hall-focus">
			...
			<div class="hall-focus-content">
				<ul>
					<c:set value="${fns:getAdvertPosit(advert_brand_man ) }" var="posit"/>
			...
			<div class="hall-focus-bg">
				<c:set value="${fns:getAdvertPosit(advert_brand_man_bottom ) }" var="posit"/>
				<c:if test="${posit != null && posit.viewNum > 0 }">
