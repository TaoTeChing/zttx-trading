...
<c:set var="result" value="${fns:searchBrandesResult('103000000',notIn)}"/>
<div class="hall clearfix">
	<div class="fl hall-m">
		<div class="tit clearfix">
			<h4 class="fl"><a href="${ctx}/underwear?st=b">内衣家居品牌馆</a></h4>
			<a href="${ctx}/underwear?st=b" class="more_1 fr"></a>
		</div>
		<div class="hall-focus">
			<a href="javascript:;" class="prev">&lt;</a>
			<a href="javascript:;" class="next">&gt;</a>
			<c:set var="topSales" value="${result['topSales']}"/>
			<div class="hall-focus-content">
				<ul>
					<c:set value="${fns:getAdvertPosit(advert_brand_underwear) }" var="posit"/>
			...
			<div class="hall-focus-bg">
				<c:set value="${fns:getAdvertPosit(advert_brand_underwear_bottom ) }" var="posit"/>
				<c:if test="${posit != null && posit.viewNum > 0 }">
			...
			<c:forEach var="item" items="${newests}">
				...
				<li>
					<div class="hall-list-hd" title="${item.brandsName}">
						...
						<%--<div class="ta-c">
                            <a href=""><img src="${res}/images/fronts/index/temp/hall_01.jpg" alt="" /></a>
                        </div>--%>
