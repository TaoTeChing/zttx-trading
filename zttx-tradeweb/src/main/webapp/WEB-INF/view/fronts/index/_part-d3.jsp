...
<c:set var="result" value="${fns:searchBrandesResult('252000000',notIn)}"/>
<div class="hall clearfix">
	<div class="fl hall-m">
		<div class="tit clearfix">
			<h4 class="fl"><a href="${ctx}/bags?st=b">箱包品牌馆</a></h4>
			<a href="${ctx}/bags?st=b" class="more_1 fr"></a>
		</div>
		<div class="hall-focus">
			...
			<div class="hall-focus-content">
				<ul>
					<c:set value="${fns:getAdvertPosit(advert_brand_bags) }" var="posit"/>
			...
			<div class="hall-focus-bg">
				<c:set value="${fns:getAdvertPosit(advert_brand_bags_bottom ) }" var="posit"/>
				<c:if test="${posit != null && posit.viewNum > 0 }">
