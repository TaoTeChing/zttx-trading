...
<head>
<meta charset="utf-8">
<title>8637品牌超级代理-店铺装修-样式管理</title>
...
<meta name="description" content="8637品牌超级代理-店铺装修">
 ...
 <link href="${res}/styles/market/brandmarket/brand_edit/stylemanage.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<div class="k-body">
    <div class="k-left f-l">
            ...
            <ul class="k-leftul">
                <li class="selected"><a href="baclkgroundset" title="" target="">背景设置</a></li>
    ...
    <div class="k-right f-l">
        ...
        <div class="k-editall">
            ...
            <div class="k-editbgcolor clear">
                <p class="pleasec"><span class="f-l">请选择背景颜色：</span><span class="colorbox f-l" style=" display:block; background:#b01000 url(${ctx}/images/fronts/market/img/cxcolor.png); width:18px; height:18px; cursor:pointer"></span></p>
