            ...
            <div class="set">
                ...
                <table class="table">
                    ...
                    <c:forEach items="${brandsDomains}" var="bd">
                    	<tr>
                            <td>${bd.brandsName}</td>
                            <td><input class="ui-input js-domin-name" type="text" style="width: 70px;" value="${bd.domain}" data-id="${bd.refrenceId}"/> .8637.com</td>
                            <td>
    ...
    var setDominName ={
        ...
        saveDominName:function(){
            ...
            $(".table").on("click",".js-save",function(){
                ...
                var refrenceId = _parent.find(".js-domin-name").data("id");
                ...
                if(!_this.dominReg(_val)){
                    ...
                    $.ajax({
                    	type:"post",
                    	url:"/brand/brandsDomain/updateDomain",
                    	data:{domain:_val,refrenceId:refrenceId},
                    	dataType:"json",
            ...
            $(".selectDominName").on("click",".js-select-domin",function(){
                ...
                if(!_this.dominReg(_val)){
                    ...
                    if(flag == true){
                        $.ajax({
                        	type:"post",
                            url:"/brand/brandsDomain/searchDomain/"+_val,
                            dataType:"json",
