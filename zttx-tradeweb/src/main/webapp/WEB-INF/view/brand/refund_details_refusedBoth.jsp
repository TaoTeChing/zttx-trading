                ...
                <div class="top clearfix">
                    ...
                    <div class="detail_box">
                        ...
                        <div class="handle_refund">
                            <h3>终端商请求退款</h3>
                            <p class="explain">您还有 <strong class="c-r time" data-endtime="${endTime}"  style=" color:red"></strong> 来处理终端商的退款申请</p>
                            <div class="detail">
                                <p class="item">
                                ...
                                <div class="item">
                                    ...
                                    <label style="vertical-align: middle" for="">拒绝理由：</label><textarea class="ui-textarea" id="remark"></textarea>
                                </div>
                                <div class="operation">
...
<script>
    $(function() {
        $("#refused").on('click', function() {
            var url = "${ctx}/brand/refund/refuseRefund";
