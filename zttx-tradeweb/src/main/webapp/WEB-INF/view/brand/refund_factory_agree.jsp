...
<head>
    <meta charset="UTF-8">
    <title>管理中心-交易管理-工厂店订单-退款详情</title>
                        ...
                        <div class="handle_refund">
                            ...
                            <form:form action="" id="subPass_Form">
                                <div class="detail">
                                    ...
                                    <div class="item">
                                        <input type="hidden" id="refrenceId" value="${dealerRefund.refrenceId}" name="refrenceId"/>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <a href="<%=ZttxConst.PAYAPI_WEBURL_RESETPWD%>" style="width: auto;margin-left: 65px;"
                                    ...
                                    <div class="operation">
                                        ...
                                        <a class="ui_button ui_button_mgray ml5" href="${ctx}/brand/refund/factory/view/${dealerRefund.refundId}">取消</a>
                                    </div>
                                </div>
                            </form:form>
                        </div>
...
<script>
    $(function () {
        ...
        $("#agreeRefund").on('click', function () {
            ...
            var url = "${ctx}/brand/refund/total/agreeReturn";
            $.ajax({
                type: "post",
                dataType: 'json',
                url: url,
