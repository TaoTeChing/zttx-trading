                ...
                <div class="top clearfix">
                    ...
                    <div class="detail_box">
                        ...
                        <div class="handle_refund">
                            ...
                            <!--  <h3>纠纷处理中…</h3>
						<c:if test="${dealerRefund.serProStatus==2}">
                        <p class="explain mt10"><strong class="c-r time"  data-endtime="${endTime}"  style=" color:red"></strong>之后系统会将${dealerRefund.refundAmount}元货款打到终端商的帐户中</p>
                		</c:if>-->
                            ...
                            <div class="detail">
                                ...
                                <c:if test="${not empty defaultBrandAddress}">
                                    <div class="item return_address">
                                        ...
                                        <input id="brandRecAddr" name="brandRecAddr'" style="width: 350px;"
                                               class="ui-input"
...
<form:form id="order_refuse" action="${ctx}/brand/refund/factory/refuse/${dealerRefund.refundId}"
