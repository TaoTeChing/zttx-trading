                    ...
                    <form:form action="" id="subPass_Form">
                        <div class="detail_box">
                            ...
                            <div class="status_contain">
                                ...
                                <div class="info">
                                    <h3>终端商已退货</h3>
                                    <p class="explain mt10">您还有 <span class="c-r time" data-endtime="${endTime}"  style=" color:red"></span> 来收货</p>
                                    <div class="item mt15">
                                        <c:if test="${hasBrandPayword==true}"><label style="vertical-align: middle" for=""  >平台支付密码：</label>
                                            ...
                                            <div class="item-remind">此密码为8637品牌超级代理平台支付密码</div></c:if>
    ...
    <div id="setPassword_box" class="setPassword_box">
        ...
        <form:form data-widget="validator" class="ui-form setPass_Form mt15" id="setPass_Form">
            <div class="ui-form-item">
                ...
                <input style="width: 200px;" data-display="支付密码" class="ui-input"  id="password" name="payWord" type="password" />
            </div>
            <div class="ui-form-item">
...
<form:form id="order_payment" action="${ctx}/brand/refund/view/agreeStauts2_pay/${dealerRefund.orderNumber}" method="post">
</form:form>
