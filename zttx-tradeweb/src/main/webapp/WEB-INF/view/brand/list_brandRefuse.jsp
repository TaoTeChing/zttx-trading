...
<head>
<meta charset="UTF-8">
    <title>管理中心-终端商管理-我拒绝的终端商</title>
        ...
        <div class="agency-seeking-contant">
            <div class="js_agency_tabs">
                ...
                <div class="js_agency_con">
                    ...
                    <div class="agency-visited agency-seeking-recom clearfix"><!--申请中的终端商-->
                        <div class="agency-seeking-order-tbody clearfix hide">
                            <div class="fl">
                                <span class="order-look">当前还可查看终端商： <em>8</em> 家</span>
                                <a href="" class="order-pagemove">订购</a>
                            </div>
                            <div class="fr">
                               	<c:choose>
    ...
    <table id="tempTable" class="agency-seeking-table">
		...
		{{each rows}}
			<tr class="{{$index%2==0 ? '':'odd'}}">
				...
				<td><span>{{$formatDate $value.auditTime}}</span></td>
				<td><span>{{$value.brandsName}}</span></td>
				<td><span>{{$value.auditMark}}</span></td>
				<td>
