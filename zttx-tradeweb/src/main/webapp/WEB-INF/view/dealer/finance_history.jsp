                        ...
                        <div class="panel-tabs">
                            <div class="panel-head">
                                 <ul>
                                    ...
                                    <a href="${ctx}/dealer/finance/history" class="yahei fs14"><li class="on">交易记录</li></a>
	...
	{{each rows}}
            <tr>
              ...
              <td class="cell-1">
     		  ...
     		  <td class="cell-1"><span class="c-r">{{$formatNumber $value.inCome}}</span></td>
   			  <td class="cell-1"><span class="c-g">{{$formatNumber $value.outAmount}}</span></td>
     		  <td class="cell-1"><span class="c-r">{{$formatNumber $value.balance}}</span></td>
            </tr>
	{{/each}}
{{ if rows.length == 0 }}
				<tr>
		    ...
		    seajs.use(["pagination", "template", "moment"], function (Pagination, template, moment) {
                ...
                template.helper('$formatNumber', function (price) {
                    if(isNaN(price)){
		                ...
		                page = new Pagination({
		                    url: "${ctx}/dealer/finance/history.json",
		                    elem: "#pagination",
		                    form: $("#ui_form"),
		                    method: "post",
