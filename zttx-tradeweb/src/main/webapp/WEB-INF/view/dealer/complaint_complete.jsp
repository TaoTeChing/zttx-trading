                ...
                <div class="main-right">
                    ...
                    <div class="main-grid mb10">
                        <div class="panel-crumbs">
                            ...
                            <i class="icon i-setting"></i><a href="${ctx}/dealer/center">管理中心</a> >> <a href="${ctx}/dealer/dealerOrder/order" title="">投诉管理</a> > <span class="bb">投诉处理完毕</span>
                            ...
                            <div class="top clearfix">
                                ...
                                <div class="detail_box">
                                    <div class="handle_refund pt40">
										<div>
											<i class="icon i-right-32 yes"></i>
										</div>
											<h3>投诉处理完毕</h3>
										<p class="explain">${dealerComplaint.complaintResult }</p>
									</div>
                                </div>
                            </div>
                        </div>
