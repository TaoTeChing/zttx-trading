...
<head>
    ...
    <title>终端商管理中心 - 商学院管理 - 我的关注</title>
    ...
    <link href="${res}/styles/dealer/SchoolIntegrationDetails.css" rel="stylesheet" />
...
<script id="ajax-templage-myAttent" _url="${ctx}/dealer/school/myAttent.json?pageSize=6" _page=".pageParent" _pid=".Content" type="text/html">
{{each rows}}
...
<script id="ajax-templage-attentMe" _url="${ctx}/dealer/school/attentMe.json?pageSize=6" _page=".pageParent" _pid=".Content" type="text/html">
{{each rows}}
<div class="AddAttention">
	<div class="fl left">
...
<script type="text/javascript">
	...
	//取消关注
	function funcCelAtt(attentId){
		$.post("${ctx}/dealer/school/attent/cancel", {attentId: attentId}, function(data){
	...
	//增加关注
	function funcAddAtt(attentId){
		$.post("${ctx}/dealer/school/attent/add", {attentId: attentId}, function(data){
			if(data.code == zttx.SUCCESS)
			{
				remind("success", "关注成功");
				var page = pageTemp;
