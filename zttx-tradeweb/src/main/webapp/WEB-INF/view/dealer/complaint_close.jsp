                ...
                <div class="main-right">
                    ...
                    <div class="main-grid mb10">
                        <div class="panel-crumbs">
                            ...
                            <i class="icon i-setting"></i><a href="${ctx}/dealer/center">管理中心</a> >> <a href="${ctx}/dealer/dealerComplaint/complaint" title="">投诉管理</a> > <span class="bb">撤销投诉</span>
                            ...
                            <div class="top clearfix">
                                ...
                                <div class="detail_box">
                                    ...
                                    <div class="handle_refund pt40">
                                        <div>
										<i class="icon i-close-big"></i>
										</div>
										<h3>投诉已关闭</h3>
										<p class="explain">您已撤销了投诉申请</p>
                                    </div>
                                </div>
                            </div>
                        </div>
