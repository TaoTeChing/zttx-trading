define(function(require, exports, module){
    ...
    require("umeditor");
    require("umeditor_config");
    require("umdeitor_style");
    ...
    function validateForm(config){
        ...
        if(this.isEditor){
            if(typeof this.editor.isValidate == "undefined"){
                this.editor.isValidate = true;
            }
        }
    ...
    validateForm.prototype = {
        ...
        validate: function(){
            ...
            //处理编辑器
            if (this.isEditor && this.editor.isValidate) {
                Core.addItem({
                    element: '#editor_hidden',
                    rule: "editor",
                    display: this.editor.display || "内容"
                })
            }
        ...
        handleEditor: function(){
            ...
            var editor = UM.getEditor(this.editor.id, {
