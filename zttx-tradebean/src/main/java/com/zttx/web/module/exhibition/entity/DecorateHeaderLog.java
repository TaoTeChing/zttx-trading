 ...
 * @version 1.0
 */
public class DecorateHeaderLog extends GenericEntity {
	...
	/**显示类型
            1：配置显示
            2：自定义内容*/
	private java.lang.Short showCate;
	/**企业名称*/
	...
	/**navBackUrl*/
	private java.lang.String navBackUrl;
	/**导航背景颜色*/
	...
	private  List<MenuJsonModel>       menus;                                    // 菜单导航
	...
	public java.lang.Short getShowCate()
	{
		return this.showCate;
	}
	
	public void setShowCate(java.lang.Short showCate)
	{
	...
	public java.lang.String getNavBackUrl()
	{
		return this.navBackUrl;
	}
	
	public void setNavBackUrl(java.lang.String navBackUrl)
	{
		this.navBackUrl = navBackUrl;
	}
