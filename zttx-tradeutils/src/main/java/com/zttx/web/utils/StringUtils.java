...
import com.zttx.sdk.utils.EncodeUtils;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils
{
     ...
     * @return boolean 如果字符串为null或空字符串(包括只含空格的字符串)则返回true,否则返回false
     */
     ...
     * 判断字符串是否为null或为空字符串
     * @param str String 待检查的字符串
     * @return boolean 如果字符串为null或空字符串(包括只含空格的字符串)则返回false,否则返回true
     */
            ...
            String newStr, boolean isIgnoreCase)
    {
        ...
        for (int pos = str_RetStr.indexOf(oldStr); pos != -1; pos = str_RetStr
                .indexOf(oldStr, pos + newStr.length()))
