/*
 * @(#)CompressUtils.java 2014-2-11 下午5:42:29
...
/**
 * <p>File：CompressUtils.java</p>
 * <p>Title: </p>
 * <p>Description:压缩/解压缩处理工具类，可进一步抽象和重构，暂时未加编码</p>
 * <p>Copyright: Copyright (c) 2014 2014-2-11 下午5:42:29</p>
        ...
        try
        {
            ...
            while ((entry = is.getNextZipEntry()) != null)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        os = new BufferedOutputStream(new FileOutputStream(new File(destDir, entry.getName())), BUFFERED_SIZE);
                        IOUtils.copy(is, os);
                    }
                    finally
                    {
            ...
            while ((entry = is.getNextArEntry()) != null)
            {
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        bos = new BufferedOutputStream(new FileOutputStream(new File(destDir, entry.getName())), BUFFERED_SIZE);
                        int len;
