/*
 * @(#)IdWorker.java 2014-4-16 上午10:05:32
 ...
 * <p>Title: </p>
 * <p>Description:</p>
 * <p>Copyright: Copyright (c) 2014 2014-4-16 上午10:05:32</p>
...
public class IdWorker
{
    ...
    public synchronized long nextId()
    {
        ...
        if (timestamp < this.lastTimestamp) try
        {
    ...
    {
        IdWorker worker2 = new IdWorker(2);// 这里的参数改为使用机器的整数IP
