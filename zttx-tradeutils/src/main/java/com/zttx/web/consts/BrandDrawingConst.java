...
/**
 * <p>File：BrandDrawingConst.java</p>
 ...
 * @version 1.0
 */
public enum BrandDrawingConst implements EnumDescribable
{
    // 状态码范围：116000到120000
    SUCCESS(116000, "成功"),
    FAILURE(116001, "失败"),
    ...
    NULERROR(116009, "请求参数格式不正确"),
    NOEXISTRESULT(116010, "请求参数不存在");

    private BrandDrawingConst(Integer code, String message)
    {
        this.code = code;
    ...
    {
        String result = null;
        for (BrandDrawingConst c : BrandDrawingConst.values())
        {
